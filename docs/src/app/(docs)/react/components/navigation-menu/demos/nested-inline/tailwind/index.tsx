  ...
  return (
    <NavigationMenu.Root className="min-w-max rounded-lg bg-gray-50 p-1 text-gray-900">
      ...
      <NavigationMenu.Portal>
        ...
        >
          <NavigationMenu.Popup className="data-[ending-style]:easing-[ease] relative h-[var(--popup-height)] w-[var(--popup-width)] origin-[var(--transform-origin)] rounded-lg bg-[canvas] text-gray-900 shadow-lg shadow-gray-200 outline-1 outline-gray-200 transition-[opacity,transform,translate,scale,width,height] duration-[var(--duration)] ease-[var(--easing)] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[ending-style]:duration-150 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 dark:shadow-none dark:outline-gray-300">
...
const submenuContentClassName =
  'h-full origin-top p-7 blur-0 min-[700px]:p-8 transition-[opacity,transform,scale,filter] duration-[300ms] ease-[cubic-bezier(0.22,1,0.36,1)] ' +
  'data-[starting-style]:scale-95 data-[starting-style]:blur-[4px] data-[starting-style]:opacity-0 ' +
  'data-[ending-style]:scale-95 data-[ending-style]:blur-[4px] data-[ending-style]:opacity-0';
